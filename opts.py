...
def parse_opts():
    ...
    parser.add_argument('--audio_channels', default=10, type=int, help='number of audio features for AudioCNN')
    ...
    parser.add_argument('--pretrain_path', default='/home/user/Downloads/EfficientFace_Trained_on_AffectNet7.pth.tar', type=str, help='Pretrained model (.pth), efficientface')
